...
export const getPelanggan = async (property = {}, use_alert = true) => {
  var query_string = new URLSearchParams(property).toString();
  let url = `/api/master/pelanggan?${query_string}`;
  console.log(url);
...
export const createPelanggan = async (property = {}, use_alert = true) => {
...
export const updatePelanggan = async (property = {}, use_alert = true) => {
  console.log(property);
  let url = `/api/master/pelanggan`;
  console.log(url);
  return new Promise((resolve) => {
